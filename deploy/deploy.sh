...
User=www-data
Group=www-data
WorkingDirectory=/opt/increlution-editor
ExecStart=/opt/increlution-editor/IncrelutionAutomationEditor.Api
Restart=always
RestartSec=10
...
echo "   - Add redirect URI: https://automations.eterm.uk/api/auth/discord/callback"
echo ""
...
echo ""
echo "5. Configure Caddy (see Caddyfile in deploy folder)"
echo ""
